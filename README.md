...
Стандарты: [AMS-1.3](https://tracker.avgst.ru/articles/ITD-A-1) · [AES-1.1](https://tracker.avgst.ru/articles/ITD-A-2). UI нет, ADS не применяется. Паспорт: [SYNC-A-1](https://tracker.avgst.ru/articles/SYNC-A-1). Git: [nikita-yakuschenko/TRB24-Sync](https://github.com/nikita-yakuschenko/TRB24-Sync), ветка `main`.
